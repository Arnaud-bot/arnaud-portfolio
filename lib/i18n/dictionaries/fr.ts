...
export const fr: Dictionary = {
  constructionBanner: {
    message:
      "Portfolio en cours de finalisation — le contenu continue d'être ajouté régulièrement.",
    dismiss: "Fermer",
  },
  meta: {
    home: {
  ...
  footer: {
    tagline:
      "Product-Focused Developer basé à Dubai. J'aide les entreprises à transformer leurs produits digitaux en expériences que les gens aiment utiliser.",
    navTitle: "Navigation",
  ...
  servicesPage: {
    ...
    description:
      "Chaque service peut être pris seul ou combiné selon où tu en es dans ton produit.",
  },
  contactPage: {
    eyebrow: "Contact",
    title: "Parlons de ton produit",
    description:
      "Décris ce que tu construis et ce qui te bloque — je réponds sous 24 à 48h.",
    linkedin: "LinkedIn",
    github: "GitHub",
    instagram: "Instagram",
    form: {
      ...
      sentBody: "Je te réponds sous 24 à 48h.",
      nameError: "Ton nom doit contenir au moins 2 caractères.",
      emailError: "Adresse email invalide.",
      messageError: "Décris ton projet en au moins 20 caractères.",
      sendError:
        "L'envoi a échoué. Réessaie, ou écris-moi directement à arnaudmalanda1@gmail.com.",
    },
  },
  workPage: {
    eyebrow: "Projets",
    ...
    chapters: {
      ...
      solution: "Solution",
      outcome: "Résultat",
      lessonsLearned: "Ce que j'en ai retenu",
